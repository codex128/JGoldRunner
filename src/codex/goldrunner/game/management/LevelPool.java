...
public class LevelPool {
	...
	/**
	 * Sorts the level pool based on the given sorting function.
	 * The sort BiFunction should return true if the first argument is
	 * "greater than" the second argument, thus placing the second argument
	 * just below the first in the partially-sorted list.
	 * @param sort 
	 */
	...
	/**
	 * Advance through the pool by the asserted amount.
	 * All visited levels are removed from the pool.
	 * @param amount the number of advances through the pool. An amount
	 * of 0 will get and remove the very next level.
